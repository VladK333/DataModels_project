...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			property2enumType.Add(ModelCode.REGULATIONGCONTROL_MODE, typeof(RegulatingControlModeKind));
			property2enumType.Add(ModelCode.REGULATIONGCONTROL_MP, typeof(PhaseCode));
			property2enumType.Add(ModelCode.POWERTRANSEND_CK, typeof(WindingConnection));
